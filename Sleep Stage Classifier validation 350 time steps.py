...
# Rearrange training and test dataset for LSTM, imported code2
...
# Apply one-hot label encoding to the PSG data, imported code2
...
# Optimizer and loss function for the LSTM model, imported code2 except the learning rate
